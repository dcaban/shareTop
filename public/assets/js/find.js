...
function latLong() {
   $.get("/api/find", function(data) {
     ...
     for (var i = 0; i < found.length; i++) {
         ...
         var cardTitle = "<div class='col s12 xl6'><div class='card searchcard'><div class='card-image'><img src='/assets/img/handbook.jpeg'><span class='card-title'>" + name + "</span> </div><div class='card-content'><p>"
